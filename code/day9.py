...
user_choice = input(" Please choose rock paper or scisscors:")
# prints option to pick a variable in terminal 
print("You chose: " + user_choice)

# let computer pick a random option 0,1,2
def cpu_choice():
    # returns a random integer from 0 - 2
    return  choices0[randint(0,2)]
    # return "The computer has chosen something..." +choices0[randint(0,2)]

# print(choices[randint(0,2)])
print("The BOT has picked: " + cpu_choice())

def compare():
    # a variable is equal to a function
    # cpu is a value, rock paper or scissors
    cpu = cpu_choice()
    # The cpu chooses random,
    print("The computer chose:", cpu)
    # user choice equal to cpu choice equals tie
    if user_choice== cpu:
        print("Tie!")
    ...
    # all possible options is user and cpu have a equal integer
    elif user_choice == "rock" and cpu == "rock":
        print("Tie")
    
    elif user_choice == "paper" and cpu == "paper":
        print("Tie")
    
    elif user_choice == "scissors" and cpu == "scissors":
        print("Tie")
#    possoible values if user_choice is not equal to 
    elif user_choice == "rock" and cpu == "paper":
        print("You Loose")
   
    elif user_choice == "paper" and cpu == "scisscors":
        print("You Loose")
   
    elif user_choice == "scisscors" and cpu == "rock":
        print("You Loose")

    #     # nothing will happen if it is not true
    # else:
    #     print: ("not samesies")
